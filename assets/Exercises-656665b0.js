import{n as a,m as t,c as n,P as o,j as e,d as u,r as g,u as j,f as _,g as v}from"./index-674a463e.js";import{s as f}from"./styled-components.browser.esm-90ee07f4.js";import{T as R}from"./Title-e96e0078.js";const L=a.li`
  margin-bottom: 20px;
...
`,k=a.span`
  ...
  font-size: 12px;
  line-height: 1.5;
`,h=({filter:i,name:r,imgURL:l})=>e.jsx(L,{children:e.jsxs(U,{children:[e.jsx(q,{src:l,alt:r}),e.jsxs(w,{children:[e.jsx(E,{children:r}),e.jsx(k,{children:i})]})]})});h.propTypes={filter:o.string.isRequired,name:o.string.isRequired,imgURL:o.string.isRequired};const z=a.ul`
  margin-top: 40px;
...
`;function M(i){return i.substring(0,1).toUpperCase()+i.substring(1)}const $=i=>i.filter.items,y=i=>i.filter.filter,b=({bodyParts:i})=>{let r=u(y),l=u($);return e.jsx(z,{children:l.filter(s=>s.filter===r).map(({filter:s,name:c,imgURL:p,_id:x})=>e.jsx(h,{imgURL:p,name:M(c),filter:s},x))})};b.propTypes={bodyParts:o.arrayOf(o.shape({name:o.string.isRequired})).isRequired};const C=f.ul`
  display: flex;
  gap: 28px;
...
`,B=()=>{const[i,r]=g.useState(!1);let l=u(y);const s=j();g.useEffect(()=>{r(!i)},[l]),g.useEffect(()=>{s(_())},[s]);const c=p=>{s(v(p.target.childNodes[0].textContent))};return e.jsx(e.Fragment,{children:e.jsxs(C,{children:[e.jsx(m,{children:e.jsx(d,{type:"button",onClick:c,children:"Body parts"})}),e.jsx(m,{children:e.jsx(d,{type:"button",onClick:c,children:"Muscles"})}),e.jsx(m,{children:e.jsx(d,{type:"button",onClick:c,children:"Equipment"})})]})})},I=a.div`
  ${t.tablet} {
    display: flex;
