import{n as I,m as et,j as f,r as Y,P as lt,c as z,z as os,A as ss,s as ce,h as fe,B as yo,D as rs,Q as cs,N as is,o as ls,u as as,E as ds}from"./index-cb13c4de.js";import{c as Pt,f as vo}from"./formatDate-d1383d55.js";import{B as us}from"./BtnSubmit-bbe6c6d1.js";const ps=(t,e)=>t==="product"?{subtitle:"DIET",title:Pt(e.title),button:"Add",text1:"Calories:",text2:"Category:",text3:"Weight:",subText1:e.calories,subText2:Pt(e.category),subText3:e.weight}:{subtitle:"WORKOUT",title:Pt(e.name),button:"Start",text1:"Burned calories:",text2:"Body part:",text3:"Target:",subText1:e.burnedCalories,subText2:Pt(e.bodyPart),subText3:Pt(e.target)},fs=I.ul`
  display: flex;
...
`,jc=I.span`
  ...
  line-height: 150%;
  color: ${z.white};
`;function ns({data:t,addExercise:e}){const{_id:n,burnedCalories:o,name:s,bodyPart:r,gifUrl:c,target:l,equipment:i,time:a}=t,[u,h]=Y.useState(0),[p,g]=Y.useState(0),[m,v]=Y.useState(!1),[C,j]=Y.useState(null),d=(T,L,U)=>{const G=Math.floor(U*T/(L*60));h(G)};Y.useEffect(()=>{d(o,a,p)},[o,a,p]);const x=()=>{g(T=>T+1)},S=()=>{const T=setInterval(x,1e3);j(T),v(!0)},M=()=>{v(!1),clearInterval(C),j(null)},F=vo(new Date),H=({remainingTime:T})=>{const L=Math.floor(T/60).toString().length>1?Math.floor(T/60):"0"+Math.floor(T/60),U=(T%60).toString().length>1?T%60:"0"+T%60;return f.jsxs(jc,{children:[L,":",U]})};return f.jsxs(bc,{children:[f.jsxs(wc,{children:[f.jsx(yc,{children:f.jsx(vc,{src:c,alt:"gif of exercise"})}),f.jsx(es,{startExercise:S,stopExercise:M,countCalory:d,calory:u,writeTime:H,isPlaying:m})]}),f.jsxs($c,{children:[f.jsxs(he,{children:[f.jsx(ge,{children:"Name"}),f.jsx(xe,{children:Pt(s)})]}),f.jsxs(he,{children:[f.jsx(ge,{children:"Target"}),f.jsx(xe,{children:Pt(l)})]}),f.jsxs(he,{children:[f.jsx(ge,{children:"Body Part"}),f.jsx(xe,{children:Pt(r)})]}),f.jsxs(he,{children:[f.jsx(ge,{children:"Equipment"}),f.jsx(xe,{children:Pt(i)})]}),f.jsxs(he,{children:[f.jsx(ge,{children:"Time"}),f.jsxs(xe,{children:[a," minutes"]})]})]}),f.jsx(Sc,{children:f.jsx(Jo,{disabled:!(u>10),type:"button",onClick:()=>e({id:n,date:F,time:p,burnedCalories:u}),children:"Add to diary"})})]})}ns.propTypes={data:lt.object.isRequired,addExercise:lt.func};yo.defaults.baseURL="https://power-pulse-rest-api.onrender.com";const Cc=rs("addProduct",async(t,{rejectWithValue:e})=>{try{await yo.post("/api/diary/add-product",t)}catch{return cs.error("Oops... Something went wrong! Try again!"),e("Oops... Something went wrong!")}}),Ec=(t,e)=>{let n=24;return e<768?n=23:e<1440&&(n=19),t.length<=n?t:t.substring(0,n)+"..."},kc=I.div`
  display: flex;
  flex-direction: column;
  width: 190px;
`,Tc=I.img`
