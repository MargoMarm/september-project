import{n as O,m as I,c as F,P as N,r as V,j as m,u as Q,a as R,t as oe,v as ce,w as pe,x as de,y as te,z as fe,s as ge,A as Z}from"./index-5fa3f891.js";import{c as ue}from"./formatDate-d1383d55.js";import{e as me,c as K,b as be,d as Y,f as he,g as xe,n as ve,h as ye,S as Ee,a as Ce}from"./swiper-5523409e.js";import{r as Le}from"./react-responsive-ef9300b4.js";import{s as se,f as ke,h as we,S as $e,P as Se,e as Ae}from"./ProductsOrExercisesItem-f0d04aed.js";import{s as G}from"./styled-components.browser.esm-b3740b0c.js";import{T as ee}from"./Title-74f24b08.js";import"./BtnSubmit-47be46fe.js";import"./notiflix-aio-3.2.6.min-923d63f5.js";const Me=O.li`
  margin-bottom: 20px;
...
`,Te=O.span`
  ...
  font-size: 12px;
  line-height: 1.5;
`,ie=({filter:g,name:e,imgURL:$,handleGetExercises:f})=>{const[d,r]=V.useState(g);V.useEffect(()=>{switch(g){case"Body parts":return r("bodyPart");case"Muscles":return r("target");case"Equipment":return r("equipment");default:return}},[g]);const b=`${d}=${e.toLowerCase()}`;return m.jsx(Me,{onClick:()=>f(b,e),children:m.jsxs(De,{children:[m.jsx(ze,{src:$,alt:e}),m.jsxs(Be,{children:[m.jsx(Ie,{children:e}),m.jsx(Te,{children:g})]})]})})};ie.propTypes={filter:N.string.isRequired,name:N.string.isRequired,imgURL:N.string.isRequired,handleGetExercises:N.func.isRequired};const je=O.ul`
  margin-top: 40px;
...
`,We=()=>{let g=R(ne);const[e,$]=V.useState(g),f=R(se),d=Q();V.useEffect(()=>{d(de())},[d,f]);const r=b=>{const h=b.target.childNodes[0].textContent;d(te(!0)),$(h),d(fe(h))};return m.jsx(m.Fragment,{children:m.jsxs(Ge,{children:[m.jsx(_,{children:m.jsx(X,{type:"button",onClick:r,className:e==="Body parts"?"active":"",children:"Body parts"})}),m.jsx(_,{children:m.jsx(X,{type:"button",onClick:r,className:e==="Muscles"?"active":"",children:"Muscles"})}),m.jsx(_,{children:m.jsx(X,{type:"button",onClick:r,className:e==="Equipment"?"active":"",children:"Equipment"})})]})})},Ue="/september-project/assets/exercises_desk_2x-598143e6.jpeg",ae=O.div`
  padding-left: 20px;
  padding-right: 20px;
...
`,Qe=G.svg`
  ...
  transition:
    scale 250ms ease-in-out,
    fill 250ms ease-in-out;
`,Ke=()=>{const g=Q(),e=()=>{g(te(!0))};return m.jsxs(Ye,{type:"button",onClick:e,children:[m.jsx(Qe,{children:m.jsx("use",{href:ge+"#icon-arrow-left"})}),"Back"]})},ra=()=>{let g=R(se),e=R(ke),$=R(Oe);const f=R(qe),d=R(we);return m.jsxs(m.Fragment,{children:[m.jsxs(ae,{children:[g?null:m.jsx(Ke,{}),m.jsxs(Ve,{children:[g?m.jsx(ee,{text:"Exercises",margin:{top:{desk:72,tab:72,mob:40},bt:{tab:32,mob:40}}}):m.jsx(ee,{text:$,margin:{top:{desk:16,tab:16,mob:12},bt:{tab:32,mob:40}}}),m.jsx(We,{})]})]}),f?m.jsx(Z,{size:"60"}):g?m.jsx(ae,{children:m.jsx(le,{})}):m.jsxs(_e,{children:[m.jsx(Xe,{}),d?m.jsx(Z,{size:"60"}):m.jsx($e,{width:{dt:"868"},children:m.jsx(Se,{children:e.map((r,b)=>b<20?m.jsx(Ae,{page:"exercise",data:r},r._id):null)})})]})]})};export{ra as default};
