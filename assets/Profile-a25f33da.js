import{n as i,m as a,c as r,y as I,d as q,J as L,r as F,u as U,j as e,s as f,K as V,P as o,M as O}from"./index-33f75ee5.js";import{T as E}from"./Title-371d2aaa.js";import{D as C,a as H,m as M}from"./descriptionTextMargin-b5a3f4f7.js";import{F as P,I as $,L as w,b as m,E as g,d as W,H as y,C as z,e as G,f as A,g as _,h as J,B as K}from"./Calendar-bfa90faa.js";import{c as X,b,e as k,f as Y,u as N}from"./formik.esm-78199566.js";import{s as R}from"./index-63473153.js";const Q=i.div`
  flex-shrink: 0;
  max-width: 439px;
  margin: 0 auto;
  ${a.desktop} {
...
`;function B({setAvatar:l}){const{name:d,avatarURL:c,dailyСalories:p,dailyTime:x}=q(L),[n,h]=F.useState(c||null),u=U(),j=v=>{h(URL.createObjectURL(v.target.files[0])),l(v.target.files[0]),URL.revokeObjectURL(n)};return e.jsxs(Q,{children:[e.jsxs(Z,{children:[n?e.jsx(te,{children:e.jsx(ie,{src:n})}):e.jsx(ee,{children:e.jsx("use",{href:`${f}#icon-gridicons_user`})}),e.jsxs(re,{children:[e.jsx("input",{type:"file",onChange:j}),e.jsx("svg",{children:e.jsx("use",{href:`${f}#icon-check-mark`})})]})]}),e.jsx(ae,{children:d||"user"}),e.jsxs(se,{children:[e.jsx(S,{children:e.jsx(C,{icon:"fork-and-knife",keyValue:(p||"0")+"",label:"Daily calorie intake",fill:"true"})}),e.jsx(S,{children:e.jsx(C,{icon:"dumbbell",keyValue:(x||0)+" min",label:"Daily norm of sports",fill:"true"})})]}),e.jsx(H,{margin:M,text:"We understand that each individual is unique, so the entire approach to diet is relative and tailored to your unique body and goals.",width:{tablet:439,desktop:439}}),e.jsxs(ne,{type:"button",onClick:()=>{V(u)},children:[e.jsx("span",{children:"Logout"}),e.jsx("svg",{children:e.jsx("use",{href:`${f}#logout_`})})]})]})}B.propTypes={setAvatar:o.func.isRequired};const oe=i.label`
  display: inline-flex;
  align-items: center;
  position: relative;
...
`;function Ce(){const[l,d]=F.useState(),c=U(),p=x=>{const n=new FormData;Object.entries(x).forEach(h=>{n.append(h[0],h[1])}),l&&n.append("avatar",l,l.name),c(O(n))};return e.jsxs(xe,{children:[e.jsx(E,{text:"Profile Settings"}),e.jsxs(ge,{children:[e.jsx(B,{setAvatar:d}),e.jsx(ue,{children:e.jsx(T,{submit:p})})]})]})}export{Ce as default};
