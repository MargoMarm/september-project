import{n as G,m as rt,j as D,r as Pt,P as ne,c as N,t as Bo,v as Do,s as rn}from"./index-40bc9a90.js";import{c as ue}from"./capitalizeWord-85339af4.js";const _o=(t,e)=>t==="product"?{subtitle:"DIET",title:ue(e.title),button:"Add",text1:"Calories:",text2:"Category:",text3:"Weight:",subText1:e.calories,subText2:ue(e.category),subText3:e.weight}:{subtitle:"WORKOUT",title:ue(e.name),button:"Start",text1:"Burned calories:",text2:"Body part:",text3:"Target:",subText1:e.burnedCalories,subText2:ue(e.bodyPart),subText3:ue(e.target)},Wo=G.ul`
  display: flex;
...
`;function fc({children:t,width:e}){const{isMobile:n}=Vo(),o=Pt.useRef(null);return dc(o,!n),D.jsx(uc,{width:e,ref:o,children:t})}fc.propTypes={width:ne.object};const pc=G.li`
  display: grid;
  position: relative;
...
`,Oc=G.svg`
  ...
  width: 24px;
  height: 24px;
`,kc=document.querySelector("#modal-root"),Tc=({children:t,openModal:e})=>{Pt.useEffect(()=>{const o=s=>{s.code==="Escape"&&e()};return window.addEventListener("keydown",o),()=>{window.removeEventListener("keydown",o)}},[e]);const n=o=>{o.currentTarget===o.target&&e()};return Do.createPortal(D.jsx($c,{onClick:n,children:D.jsxs(Ec,{children:[D.jsx(Cc,{type:"button",onClick:()=>e(),children:D.jsx(Oc,{children:D.jsx("use",{href:rn+"#close"})})}),t]})}),kc)};G.div`
  background-color: ${N.modalBlack};
  border-radius: 12px;
  padding: 48px 24px;
  ${rt.tablet} {
...
`;function Io({data:t,closeModal:e}){const[n,o]=Pt.useState(0),s=Math.round(n*t.calories/100);return D.jsxs("form",{children:[D.jsxs(jc,{children:[D.jsx("label",{children:D.jsx(zc,{type:"text",value:t.title,disabled:!0})}),D.jsx("label",{children:D.jsx(Pc,{placeholder:"grams",type:"number",value:n,onChange:c=>o(c.target.value)})})]}),D.jsxs(Mc,{children:[D.jsx(Lc,{children:"Calories:"})," ",s]}),D.jsxs(Ac,{children:[D.jsx(Hc,{type:"button",children:"Add to diary"}),D.jsx(Rc,{type:"button",onClick:e,children:"Cancel"})]})]})}Io.propTypes={data:ne.object,closeModal:ne.func};const Ic=({page:t,data:e})=>{const[n,o]=Pt.useState(window.innerWidth),[s,c]=Pt.useState(!1),r=()=>c(d=>!d);Pt.useEffect(()=>(window.addEventListener("resize",a),()=>{window.removeEventListener("resize",a)}),[]);const a=()=>{o(window.innerWidth)},l=d=>{let g=24;return n<768?g=23:n<1440&&(g=19),d.length<=g?d:d.substring(0,g)+"..."},i=_o(t,e);return D.jsxs(pc,{children:[D.jsxs(hc,{children:[D.jsx(gc,{children:i.subtitle}),t==="product"&&D.jsx(bc,{children:"Recommended"}),D.jsxs(xc,{onClick:r,children:[i.button,D.jsx(mc,{children:D.jsx("use",{href:rn+"#arrow-right"})})]})]}),D.jsxs(vc,{children:[D.jsx(wc,{children:D.jsx(yc,{children:D.jsx("use",{href:rn+"#runningMan"})})}),l(i.title)]}),D.jsxs(Sc,{children:[D.jsxs(sn,{children:[i.text1,D.jsx(cn,{children:i.subText1})]}),D.jsxs(sn,{children:[i.text2,D.jsx(cn,{children:i.subText2})]}),D.jsxs(sn,{children:[i.text3,D.jsx(cn,{children:i.subText3})]})]}),s&&D.jsx(Tc,{openModal:r,children:t==="product"&&D.jsx(Io,{closeModal:r,data:e})})]})};Ic.propTypes={page:ne.string,data:ne.object,openModal:ne.func};export{_c as P,fc as S,Ic as a};
