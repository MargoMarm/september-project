import{n as O,m as I,c as F,P as N,r as V,j as m,u as Q,a as R,t as oe,v as ce,w as pe,x as de,y as te,z as fe,s as ge,A as Z}from"./index-295e236b.js";import{c as ue}from"./formatDate-d1383d55.js";import{e as me,c as K,b as be,d as Y,f as he,g as xe,n as ve,h as ye,S as Ee,a as Ce}from"./swiper-02fe146a.js";import{r as Le}from"./react-responsive-75f5d2c8.js";import{s as G}from"./styled-components.browser.esm-b9f2e159.js";import{T as ee}from"./Title-be5b43de.js";import{S as ke,P as we,e as $e}from"./ProductsOrExercisesItem-eec8f867.js";import"./BtnSubmit-4ddeedb3.js";const Se=O.li`
  margin-bottom: 20px;
...
`,We=()=>{let d=R(ie);const[e,$]=V.useState(d),g=R(le),f=Q();V.useEffect(()=>{f(de())},[f,g]);const r=b=>{const h=b.target.childNodes[0].textContent;f(te(!0)),$(h),f(fe(h))};return m.jsx(m.Fragment,{children:m.jsxs(Ge,{children:[m.jsx(_,{children:m.jsx(X,{type:"button",onClick:r,className:e==="Body parts"?"active":"",children:"Body parts"})}),m.jsx(_,{children:m.jsx(X,{type:"button",onClick:r,className:e==="Muscles"?"active":"",children:"Muscles"})}),m.jsx(_,{children:m.jsx(X,{type:"button",onClick:r,className:e==="Equipment"?"active":"",children:"Equipment"})})]})})},Ue="/september-project/assets/exercises_desk_2x-598143e6.jpeg",ae=O.div`
  padding-left: 20px;
  padding-right: 20px;
