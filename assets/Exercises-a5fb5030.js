import{n as O,m as I,c as R,P as N,r as G,j as g,u as _,a as q,v as oe,w as ce,x as pe,y as de,z as fe,A as te,B as ge,s as ue,k as Z,D as me}from"./index-a3e616c5.js";import{s as se,f as be,h as he,i as xe,j as ve,S as ye,I as Ee,P as Ce,e as Le}from"./ProductsOrExercisesItem-2417915e.js";import{c as ke}from"./formatDate-d1383d55.js";import{e as we,c as K,b as Se,d as Q,f as $e,g as Me,n as Ae,h as De,S as Be,a as ze}from"./swiper-db3f4336.js";import{r as Ie}from"./react-responsive-228d3f64.js";import{s as W}from"./styled-components.browser.esm-5931c0b9.js";import{T as ee}from"./Title-e67343ff.js";import{i as Pe}from"./exercises_desk_2x-1531e374.js";import"./BtnSubmit-69016a57.js";import"./notiflix-aio-3.2.6.min-8bb4527b.js";const Te=O.li`
  margin-bottom: 20px;
...
`,Re=O.span`
  ...
  font-size: 12px;
  line-height: 1.5;
`,ie=({filter:u,name:e,imgURL:w,handleGetExercises:f})=>{const[d,o]=G.useState(u);G.useEffect(()=>{switch(u){case"Body parts":return o("bodyPart");case"Muscles":return o("target");case"Equipment":return o("equipment");default:return}},[u]);const h=`${d}=${e.toLowerCase()}`;return g.jsx(Te,{onClick:()=>f(h,e),children:g.jsxs(je,{children:[g.jsx(qe,{src:w,alt:e}),g.jsxs(Oe,{children:[g.jsx(Fe,{children:e}),g.jsx(Re,{children:u})]})]})})};ie.propTypes={filter:N.string.isRequired,name:N.string.isRequired,imgURL:N.string.isRequired,handleGetExercises:N.func.isRequired};const He=O.ul`
  margin-top: 40px;
...
`,Qe=()=>{let u=q(ne);const[e,w]=G.useState(u),f=q(se),d=_();G.useEffect(()=>{d(fe())},[d,f]);const o=h=>{const m=h.target.childNodes[0].textContent;d(te(!0)),w(m),d(ge(m))};return g.jsx(g.Fragment,{children:g.jsxs(Ye,{children:[g.jsx(X,{children:g.jsx(Y,{type:"button",onClick:o,className:e==="Body parts"?"active":"",children:"Body parts"})}),g.jsx(X,{children:g.jsx(Y,{type:"button",onClick:o,className:e==="Muscles"?"active":"",children:"Muscles"})}),g.jsx(X,{children:g.jsx(Y,{type:"button",onClick:o,className:e==="Equipment"?"active":"",children:"Equipment"})})]})})},ae=O.div`
  padding-left: 20px;
  padding-right: 20px;
...
`,aa=W.svg`
  ...
  transition:
    scale 250ms ease-in-out,
    fill 250ms ease-in-out;
`,ta=()=>{const u=_(),e=()=>{u(te(!0))};return g.jsxs(ea,{type:"button",onClick:e,children:[g.jsx(aa,{children:g.jsx("use",{href:ue+"#icon-arrow-left"})}),"Back"]})},ga=()=>{const[u,e]=G.useState(1);let w=q(se),f=q(be),d=q(Ge);const o=q(We),h=q(he),m=_(),y=q(xe),D=q(ve);G.useEffect(()=>{e(1)},[y]);const C=()=>{if(u===1){e(M=>M+1);return}const L=new URLSearchParams({page:u,limit:20}).toString();m(me(`${y}&${L}`)),e(M=>M+1)};return g.jsxs(g.Fragment,{children:[g.jsxs(ae,{children:[w?null:g.jsx(ta,{}),g.jsxs(Ke,{children:[w?g.jsx(ee,{text:"Exercises",margin:{top:{desk:72,tab:72,mob:40},bt:{tab:32,mob:40}}}):g.jsx(ee,{text:d,margin:{top:{desk:16,tab:16,mob:12},bt:{tab:32,mob:40}}}),g.jsx(Qe,{})]})]}),o?g.jsx(Z,{size:"60"}):w?g.jsx(ae,{children:g.jsx(re,{})}):g.jsxs(Je,{children:[g.jsx(Ze,{}),g.jsx(ye,{width:{dt:"878"},children:g.jsx(Ee,{pageStart:0,loadMore:C,hasMore:D&&!h,loader:g.jsx(Z,{},"qwe258"),useWindow:!1,children:g.jsx(Ce,{children:f.map(L=>g.jsx(Le,{page:"exercise",data:L},L._id))})})})]})]})};export{ga as default};
