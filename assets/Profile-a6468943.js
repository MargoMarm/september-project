import{n as i,m as a,c as r,t as I,f as q,B as L,r as F,u as U,j as e,s as f,D as V,P as o,E}from"./index-95d477e9.js";import{T as O}from"./Title-441d47bb.js";import{D as C,a as H,m as P}from"./descriptionTextMargin-d9d21b39.js";import{F as z,I as $,L as w,b as m,E as g,c as W,H as y,C as G,d as M,e as A,f as _,g as X,B as Y,s as B}from"./Calendar-85dbf94c.js";import{c as J,b,e as k,f as K,u as N}from"./formik.esm-f6dbb672.js";import"./emotion-react.browser.esm-bf772f24.js";const Q=i.div`
  flex-shrink: 0;
  max-width: 439px;
  margin: 0 auto;
  ${a.desktop} {
...
`;function Ce(){const[l,d]=F.useState(),c=U(),p=x=>{const n=new FormData;Object.entries(x).forEach(h=>{n.append(h[0],h[1])}),l&&n.append("avatar",l,l.name),c(E(n))};return e.jsxs(xe,{children:[e.jsx(O,{text:"Profile Settings"}),e.jsxs(ge,{children:[e.jsx(R,{setAvatar:d}),e.jsx(ue,{children:e.jsx(T,{submit:p})})]})]})}export{Ce as default};
