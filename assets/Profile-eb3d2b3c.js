import{n as i,m as a,c as r,B as I,a as q,O as L,r as U,u as F,j as e,s as f,S as O,P as o,U as V}from"./index-a6c0a827.js";import{T as E}from"./Title-35aa4539.js";import{D as C,a as H,m as P}from"./descriptionTextMargin-f1c7acf1.js";import{F as z,I as $,L as w,b as m,E as g,d as W,H as y,C as G,e as M,f as A,g as _,h as X,B as Y}from"./Calendar-6a0a8eca.js";import{c as J,b,e as k,f as K,u as N}from"./formik.esm-b550bb40.js";import{s as B}from"./index-58283bae.js";const Q=i.div`
  flex-shrink: 0;
  max-width: 439px;
  margin: 0 auto;
  ${a.desktop} {
...
`;function R({setAvatar:l}){const{name:d,avatarURL:c,dailyСalories:p,dailyTime:x}=q(L),[n,h]=U.useState(c||null),u=F(),j=v=>{h(URL.createObjectURL(v.target.files[0])),l(v.target.files[0]),URL.revokeObjectURL(n)};return e.jsxs(Q,{children:[e.jsxs(Z,{children:[n?e.jsx(te,{children:e.jsx(ie,{src:n})}):e.jsx(ee,{children:e.jsx("use",{href:`${f}#icon-gridicons_user`})}),e.jsxs(re,{children:[e.jsx("input",{type:"file",onChange:j}),e.jsx("svg",{children:e.jsx("use",{href:`${f}#icon-check-mark`})})]})]}),e.jsx(ae,{children:d||"user"}),e.jsxs(se,{children:[e.jsx(S,{children:e.jsx(C,{icon:"fork-and-knife",keyValue:(p||"0")+"",label:"Daily calorie intake",fill:"true"})}),e.jsx(S,{children:e.jsx(C,{icon:"dumbbell",keyValue:(x||0)+" min",label:"Daily norm of sports",fill:"true"})})]}),e.jsx(H,{margin:P,text:"We understand that each individual is unique, so the entire approach to diet is relative and tailored to your unique body and goals.",width:{tablet:439,desktop:439}}),e.jsxs(ne,{type:"button",onClick:()=>{O(u)},children:[e.jsx("span",{children:"Logout"}),e.jsx("svg",{children:e.jsx("use",{href:`${f}#logout_`})})]})]})}R.propTypes={setAvatar:o.func.isRequired};const oe=i.label`
  display: inline-flex;
  align-items: center;
  position: relative;
...
`;function Ce(){const[l,d]=U.useState(),c=F(),p=x=>{const n=new FormData;Object.entries(x).forEach(h=>{n.append(h[0],h[1])}),l&&n.append("avatar",l,l.name),c(V(n))};return e.jsxs(xe,{children:[e.jsx(E,{text:"Profile Settings"}),e.jsxs(ge,{children:[e.jsx(R,{setAvatar:d}),e.jsx(ue,{children:e.jsx(T,{submit:p})})]})]})}export{Ce as default};
