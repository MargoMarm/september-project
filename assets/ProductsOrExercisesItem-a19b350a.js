import{n as ut,m as Tt,j as et,r as oe,P as Te,c as xt,s as Ln}from"./index-ff23f3b9.js";import{c as ue}from"./capitalizeWord-85339af4.js";const Io=(t,e)=>t==="product"?{subtitle:"DIET",title:ue(e.title),button:"Add",text1:"Calories:",text2:"Category:",text3:"Weight:",subText1:e.calories,subText2:ue(e.category),subText3:e.weight}:{subtitle:"WORKOUT",title:ue(e.name),button:"Start",text1:"Burned calories:",text2:"Body part:",text3:"Target:",subText1:e.burnedCalories,subText2:ue(e.bodyPart),subText3:ue(e.target)},_o=ut.ul`
  display: flex;
...
`;function ac({children:t,width:e}){const{isMobile:n}=Fo(),o=oe.useRef(null);return ic(o,!n),et.jsx(lc,{width:e,ref:o,children:t})}ac.propTypes={width:Te.object};const uc=ut.li`
  ...
  border-radius: 12px;
  border: 1px solid ${xt.textWhite02};
  background: ${xt.textWhite005};
...
`,fc=ut.p`
  ...
  background-color: ${xt.textWhite005};
  border-radius: 4px;
  color: #fff;
`,pc=ut.p`
  display: flex;
...
`,hc=ut.button`
  ...
  &:hover {
    scale: 1.1;
    color: ${xt.orangeSecondary};

    svg {
      stroke: ${xt.orangeSecondary};
    }
  }
