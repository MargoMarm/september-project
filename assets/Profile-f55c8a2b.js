import{n as i,m as a,c as r,y as I,d as q,G as L,r as F,u as U,j as e,s as f,H as V,P as o,I as O}from"./index-bf949111.js";import{T as E}from"./Title-5150b6e4.js";import{D as C,a as H,m as G}from"./descriptionTextMargin-402d834f.js";import{F as P,I as $,L as w,b as m,E as g,d as W,H as y,C as z,e as M,f as A,g as _,h as X,B as Y}from"./Calendar-b8a66b6f.js";import{c as J,b,e as k,f as K,u as N}from"./formik.esm-01683e4d.js";import{s as R}from"./index-1ba4ae71.js";const Q=i.div`
  flex-shrink: 0;
  max-width: 439px;
  margin: 0 auto;
  ${a.desktop} {
...
`;function B({setAvatar:l}){const{name:d,avatarURL:c,dailyСalories:p,dailyTime:x}=q(L),[n,h]=F.useState(c||null),u=U(),j=v=>{h(URL.createObjectURL(v.target.files[0])),l(v.target.files[0]),URL.revokeObjectURL(n)};return e.jsxs(Q,{children:[e.jsxs(Z,{children:[n?e.jsx(te,{children:e.jsx(ie,{src:n})}):e.jsx(ee,{children:e.jsx("use",{href:`${f}#icon-gridicons_user`})}),e.jsxs(re,{children:[e.jsx("input",{type:"file",onChange:j}),e.jsx("svg",{children:e.jsx("use",{href:`${f}#icon-check-mark`})})]})]}),e.jsx(ae,{children:d||"user"}),e.jsxs(se,{children:[e.jsx(S,{children:e.jsx(C,{icon:"fork-and-knife",keyValue:(p||"0")+"",label:"Daily calorie intake",fill:"true"})}),e.jsx(S,{children:e.jsx(C,{icon:"dumbbell",keyValue:(x||0)+" min",label:"Daily norm of sports",fill:"true"})})]}),e.jsx(H,{margin:G,text:"We understand that each individual is unique, so the entire approach to diet is relative and tailored to your unique body and goals.",width:{tablet:439,desktop:439}}),e.jsxs(ne,{type:"button",onClick:()=>{V(u)},children:[e.jsx("span",{children:"Logout"}),e.jsx("svg",{children:e.jsx("use",{href:`${f}#logout_`})})]})]})}B.propTypes={setAvatar:o.func.isRequired};const oe=i.label`
  display: inline-flex;
  align-items: center;
  position: relative;
