import{n as i,m as a,c as r,E as V,a as q,U as L,r as U,u as F,j as e,s as f,V as I,P as o,W as E}from"./index-34023d96.js";import{T as O}from"./Title-cd8269bd.js";import{D as C,a as H,m as P}from"./descriptionTextMargin-c4e6b0cd.js";import{F as z,I as $,L as w,b as m,E as g,d as W,H as y,C as G,e as M,f as A,g as _,h as X,B as Y}from"./Calendar-856f0305.js";import{c as J,b,e as k,f as K,u as N}from"./formik.esm-5aa622bc.js";import{s as R}from"./index-c7deb0e8.js";const Q=i.div`
  flex-shrink: 0;
  max-width: 439px;
  margin: 0 auto;
  ${a.desktop} {
...
`;function Ce(){const[l,d]=U.useState(),c=F(),p=x=>{const n=new FormData;Object.entries(x).forEach(h=>{n.append(h[0],h[1])}),l&&n.append("avatar",l,l.name),c(E(n))};return e.jsxs(xe,{children:[e.jsx(O,{text:"Profile Settings"}),e.jsxs(ge,{children:[e.jsx(B,{setAvatar:d}),e.jsx(ue,{children:e.jsx(T,{submit:p})})]})]})}export{Ce as default};
