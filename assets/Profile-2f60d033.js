import{n as i,m as a,c as r,t as I,f as q,z as L,r as F,u as U,j as e,s as f,A as V,P as o,B as O}from"./index-40bc9a90.js";import{T as E}from"./Title-5a4027f7.js";import{D as C,a as z,m as H}from"./descriptionTextMargin-316db784.js";import{F as P,I as $,L as w,b as m,E as g,c as W,H as y,C as G,d as M,e as A,f as _,g as X,B as Y,s as B}from"./Calendar-adbc6714.js";import{c as J,b,e as k,f as K,u as N}from"./formik.esm-63777da8.js";import"./emotion-react.browser.esm-95915ccd.js";const Q=i.div`
  flex-shrink: 0;
  max-width: 439px;
  margin: 0 auto;
  ${a.desktop} {
...
`;function Ce(){const[l,d]=F.useState(),c=U(),p=x=>{const n=new FormData;Object.entries(x).forEach(h=>{n.append(h[0],h[1])}),l&&n.append("avatar",l,l.name),c(O(n))};return e.jsxs(xe,{children:[e.jsx(E,{text:"Profile Settings"}),e.jsxs(ge,{children:[e.jsx(R,{setAvatar:d}),e.jsx(ue,{children:e.jsx(T,{submit:p})})]})]})}export{Ce as default};
