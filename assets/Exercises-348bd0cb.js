import{n as O,m as I,c as R,P as N,r as G,j as g,u as _,a as q,v as oe,w as ce,x as pe,y as de,z as fe,A as te,B as ge,s as ue,k as Z,D as me}from"./index-8ea579d5.js";import{s as se,f as be,h as he,i as xe,j as ve,S as ye,I as Ee,P as Ce,e as Le}from"./ProductsOrExercisesItem-fa0b1541.js";import{c as ke}from"./formatDate-d1383d55.js";import{e as we,c as K,b as Se,d as Q,f as $e,g as Me,n as Ae,h as De,S as Be,a as ze}from"./swiper-f1540dbe.js";import{r as Ie}from"./react-responsive-bc6f8237.js";import{s as W}from"./styled-components.browser.esm-4f639c7a.js";import{T as ee}from"./Title-b9eb75ec.js";import"./BtnSubmit-3786ca34.js";import"./notiflix-aio-3.2.6.min-224745b6.js";const Pe=O.li`
  margin-bottom: 20px;
...
`,Te=O.a`
  ...
  position: relative;
  border-radius: 12px;
  background-color: ${R.background05};
`,je=O.img`
  position: relative;
  width: 100%;
  border-radius: 12px;
...
`,Fe=O.span`
  ...
  font-size: 12px;
  line-height: 1.5;
`,ie=({filter:u,name:e,imgURL:w,handleGetExercises:f})=>{const[d,o]=G.useState(u);G.useEffect(()=>{switch(u){case"Body parts":return o("bodyPart");case"Muscles":return o("target");case"Equipment":return o("equipment");default:return}},[u]);const h=`${d}=${e.toLowerCase()}`;return g.jsx(Pe,{onClick:()=>f(h,e),children:g.jsxs(Te,{children:[g.jsx(je,{src:w,alt:e}),g.jsxs(qe,{children:[g.jsx(Oe,{children:e}),g.jsx(Fe,{children:u})]})]})})};ie.propTypes={filter:N.string.isRequired,name:N.string.isRequired,imgURL:N.string.isRequired,handleGetExercises:N.func.isRequired};const Re=O.ul`
  margin-top: 40px;
...
`,Ye=()=>{let u=q(ne);const[e,w]=G.useState(u),f=q(se),d=_();G.useEffect(()=>{d(fe())},[d,f]);const o=h=>{const m=h.target.childNodes[0].textContent;d(te(!0)),w(m),d(ge(m))};return g.jsx(g.Fragment,{children:g.jsxs(Xe,{children:[g.jsx(X,{children:g.jsx(Y,{type:"button",onClick:o,className:e==="Body parts"?"active":"",children:"Body parts"})}),g.jsx(X,{children:g.jsx(Y,{type:"button",onClick:o,className:e==="Muscles"?"active":"",children:"Muscles"})}),g.jsx(X,{children:g.jsx(Y,{type:"button",onClick:o,className:e==="Equipment"?"active":"",children:"Equipment"})})]})})},Qe="/september-project/assets/exercises_desk_2x-598143e6.jpeg",ae=O.div`
  padding-left: 20px;
  padding-right: 20px;
...
`,aa=W.svg`
  ...
  transition:
    scale 250ms ease-in-out,
    fill 250ms ease-in-out;
`,ta=()=>{const u=_(),e=()=>{u(te(!0))};return g.jsxs(ea,{type:"button",onClick:e,children:[g.jsx(aa,{children:g.jsx("use",{href:ue+"#icon-arrow-left"})}),"Back"]})},fa=()=>{const[u,e]=G.useState(1);let w=q(se),f=q(be),d=q(Ne);const o=q(Ge),h=q(he),m=_(),y=q(xe),D=q(ve);G.useEffect(()=>{e(1)},[y]);const C=()=>{if(u===1){e(M=>M+1);return}const L=new URLSearchParams({page:u,limit:20}).toString();m(me(`${y}&${L}`)),e(M=>M+1)};return g.jsxs(g.Fragment,{children:[g.jsxs(ae,{children:[w?null:g.jsx(ta,{}),g.jsxs(Ke,{children:[w?g.jsx(ee,{text:"Exercises",margin:{top:{desk:72,tab:72,mob:40},bt:{tab:32,mob:40}}}):g.jsx(ee,{text:d,margin:{top:{desk:16,tab:16,mob:12},bt:{tab:32,mob:40}}}),g.jsx(Ye,{})]})]}),o?g.jsx(Z,{size:"60"}):w?g.jsx(ae,{children:g.jsx(re,{})}):g.jsxs(Je,{children:[g.jsx(Ze,{}),g.jsx(ye,{width:{dt:"878"},children:g.jsx(Ee,{pageStart:0,loadMore:C,hasMore:D&&!h,loader:g.jsx(Z,{},"qwe258"),useWindow:!1,children:g.jsx(Ce,{children:f.map(L=>g.jsx(Le,{page:"exercise",data:L},L._id))})})})]})]})};export{fa as default};
