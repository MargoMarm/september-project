...
export default function Checkbox({styleWrapper, styleCheckbox, styleText, name, value, checked, onChange, children}) {
  return (
    <CheckboxWrap style={styleWrapper || null}>
      <InputHidden type="radio" name={name} value={value} checked={checked || false} onChange={onChange || null}/>
